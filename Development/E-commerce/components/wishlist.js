...
loadProducts()
  .then(products => {
    ...
    if (favorites.length === 0) {
      wishlistCount.innerHTML = `<strong>Wishlist (${favorites.length})</strong> </p><p class="text-danger"> Your Wishlist Is Empty </p>`;
    }
    else {
    ...
    const nonWishlisted = products.filter(p => !favorites.includes(p.id)).slice(0);
                    ...
                    <div class="col">
                      <div class="card h-100 position-relative" data-id="${product.id}">
                        ...
                        <div class="card-body text-center">
                          ...
                          <button class="btn btn-dark w-100 add-cart mb-2"><i class="bi bi-cart-fill me-2"></i> Add To Cart</button>
        ...
        if (index > -1) {
          ...
          nonWishlisted.forEach(product => {
            ...
            const justForYouCard = `
                                <div class="col">
                                  <div class="card h-100 position-relative" data-id="${productId}">
                                    ${discountBadge}
                                    <div class="position-absolute top-0 end-0 m-2 d-flex flex-column align-items-center">
                                      <span class="bg-white rounded-circle p-2">
                                        <i class="bi bi-eye text-secondary"></i>
